...
set :deploy_to, '/home/ubuntu/RailsApps/www.annarborequipmentsanitizing.com'
...
# set :linked_files, %w{config/database.yml config/paypal.yml config/authorize_net.yml config/smtp.yml}
